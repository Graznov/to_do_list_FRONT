...
import {ReactComponent as LogoNote} from "/src/assets/note-svgrepo-com.svg";
...
import NoteRedacted from "./Components/note/NewNote.tsx";
...
function WorkWind() {
    ...
    const clickAddTask = () => {
        if (listName==='Note'){
            ...
            console.log(`noteAddWindowVisibl: ${noteAddWindowVisibl}`)
        } else {
    ...
    return (
        ...
        <>
            ...
            <div className={cx('work_container',{
                'work_container_opasity':(styleWindAddTask || noteAddWindowVisibl),
                'work_container_opasity_dark':styleWindAddTask && theme==='dark',

                // 'work_container_opasity':WindAddNote,
                // 'work_container_opasity_dark':WindAddNote && theme==='dark',

                'work_container_dark':theme==='dark'
            })}>

                <div className={cx('work_container_leftPanel',{
                    'work_container_PanelDeactive':styleWindAddTask || noteAddWindowVisibl,
                    ...
                    <div className={cx('work_container_leftPanel_calendar')}>
                        ...
                        <LeftPanelBtn
                            className={cx('button', 'noteBtn',{
                                'noteBtn_dark':theme==='dark',
                                'button_dark':theme==='dark',
                                'MyListBtn_Active':listName==='Note',
                                'MyListBtn_Note_Active':listName==='Note',
                                'MyListBtn_Active_dark':theme==='dark' && listName==='Note'
                            })}
                            logo={<LogoNote
                                className={cx('logogo', 'noteLogogo',{
                                'logogo_dark':theme==='dark'
                            })}/>}
                            adress={'/workwindow/notelist'}
                            text_btn={langMap.notebook}
                            logo2={undefined}
                            Click={()=>{
                                dispatch(changeTaskList('Note'))
                            }}
                            number={data.notes.length.toString()}
